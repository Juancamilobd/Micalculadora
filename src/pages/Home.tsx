    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen>
                ...
                <IonRow>
                        <IonButton className="button1" onClick={() => handleClick("*")}>multi</IonButton>
                        <IonButton className="button1" onClick={() => handleClick("-")}>resta</IonButton>
                        <IonButton className="button1" onClick={() => handleClick("C")}>C</IonButton>
                        <IonButton className="button1" onClick={() => handleClick("/")}>div</IonButton>
                        <IonButton className="button1" onClick={() => handleClick("+")}>suma</IonButton>
